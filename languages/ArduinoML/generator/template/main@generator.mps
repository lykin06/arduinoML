    ...
    <node concept="9aQIb" id="7XO5aLLJvVv" role="13RCb5">
      <node concept="3clFbS" id="7XO5aLLJvVw" role="9aQI4">
        ...
        <node concept="3clFbF" id="7XO5aLLJzUZ" role="3cqZAp">
          ...
          <node concept="2b32R4" id="v2JSW2Rn_$" role="lGtFl">
            <node concept="3JmXsc" id="v2JSW2Rn_B" role="2P8S$">
              <node concept="3clFbS" id="v2JSW2Rn_C" role="2VODD2">
                <node concept="3clFbF" id="v2JSW2RoYT" role="3cqZAp">
                  <node concept="37vLTI" id="v2JSW2RpGY" role="3clFbG">
                    <node concept="2OqwBi" id="v2JSW2RpNw" role="37vLTx">
                      <node concept="30H73N" id="v2JSW2RpJt" role="2Oq$k0" />
                      <node concept="3TrcHB" id="v2JSW2RpT1" role="2OqNvi">
                        <ref role="3TsBF5" to="tpck:h0TrG11" resolve="name" />
                      </node>
                    </node>
                    <node concept="2OqwBi" id="v2JSW2RpoL" role="37vLTJ">
                      <node concept="1iwH7S" id="v2JSW2RoYR" role="2Oq$k0" />
                      <node concept="2fSANN" id="v2JSW2RprH" role="2OqNvi">
                        <node concept="Xl_RD" id="v2JSW2RptP" role="2fWi3N">
                          <property role="Xl_RC" value="current_state_name" />
                        </node>
                      </node>
                    </node>
                ...
                <node concept="3clFbF" id="v2JSW2Rn_I" role="3cqZAp">
                  <node concept="2OqwBi" id="v2JSW2Rn_D" role="3clFbG">
                    <node concept="3Tsc0h" id="v2JSW2Rn_G" role="2OqNvi">
                      <ref role="3TtcxE" to="khqa:7XO5aLLH$jO" />
                    </node>
                    <node concept="30H73N" id="v2JSW2Rn_H" role="2Oq$k0" />
                  </node>
                </node>
              </node>
            </node>
